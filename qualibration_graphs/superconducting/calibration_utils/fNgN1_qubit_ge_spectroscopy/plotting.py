"""Plotting utilities for qubit ge spectroscopy at Fock |N⟩."""
...
def plot_raw_data_with_fit(
    ...
    """Plot ge spectroscopy at Fock N with Lorentzian fit overlay."""
    k = fock_level
    ...
    fig.suptitle(f"ge spectroscopy at Fock {k+1} — {mode_name}")
    fig.tight_layout()
    return fig
