...
class NodeSpecificParameters(RunnableParameters):
    ...
    |fock_n⟩ down to vacuum by driving |n,g⟩â†’|n-1,f⟩ and waiting for qubit
    ...
    """Reduced chiÂ² threshold for accepting a multi-Gaussian fit.
    chi2 = SS_res / ((N - P) * aÂ²), same convention as power_rabi.
    chi2 â‰¤ 2 means residual RMS â‰¤ a/âˆš2 (signal clearly above noise). Lower = stricter."""
