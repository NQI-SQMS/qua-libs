...
class NodeSpecificParameters(RunnableParameters):
    ...
    cz_branch: Literal["20", "02", "auto"] = "auto"
    """CZ avoided-crossing branch to establish for downstream CZ nodes and persist to
    qp.extras["cz_branch"]: "20" (control->|2>), "02" (target->|2>), or "auto" (pick the
    physically reachable branch from the stored qubit frequencies). Default is "auto"."""
