"""Parameter definitions for conditional qubit spectroscopy vs flux calibration (control in |f>)."""
...
class NodeSpecificParameters(RunnableParameters):
    """Node-specific parameters for conditional qubit spectroscopy vs flux calibration."""

    num_shots: int = 50
    """Number of averages to perform. Default is 50."""
    operation: str = "saturation"
    """Operation to perform on the target qubit. Default is "saturation"."""
    ...
    """Frequency span in MHz (around the target qubit's bare frequency). Default is 100 MHz."""
    frequency_step_in_mhz: float = 0.5
    """Frequency step in MHz. Default is 0.5 MHz."""
    flux_offset_span_in_v: float = 0.05
    """Flux bias offset span in volts, applied on the target qubit's flux line. Default is 0.05 V."""
...
class Parameters(
    ...
    """Combined parameters for conditional qubit spectroscopy vs flux calibration."""
