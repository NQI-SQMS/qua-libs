...
class NodeSpecificParameters(RunnableParameters):
    ...
    """Signal used for analysis and plotting: 'I_rot' (PCA-rotated quadrature), 'IQ_abs' (magnitude),
    or 'I' (raw I quadrature, assumes hardware rotation already applied via integration_weights_angle).
    When 'IQ_abs' or 'I' is chosen the integration weight angle is NOT updated."""
