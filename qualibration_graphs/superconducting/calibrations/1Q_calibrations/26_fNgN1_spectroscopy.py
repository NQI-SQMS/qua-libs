                ...
                with for_(*from_array(f, dfs)):
                    for i, qubit in multiplexed_qubits.items():
                        ...
                        if op == "sideband_flat_top":
                            ...
                            with strict_timing_():
                                sideband_drive.play("sideband_ramp_up", amplitude_scale=amp_scale)
                                if flat_cc is not None:
                                    sideband_drive.play("sideband_square", amplitude_scale=amp_scale, duration=flat_cc)
                                else:
                                    sideband_drive.play("sideband_square", amplitude_scale=amp_scale)
                                sideband_drive.play("sideband_ramp_down", amplitude_scale=amp_scale)
